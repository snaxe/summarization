...
public class SentiScore {
	...
	public SentiScore(InputStream pathToSWN) throws IOException {
		...
		try {
			pathToSWN = StopWords.class.getClassLoader().getResourceAsStream("SentiWordNet.txt");
...
//		SentiScoreTest sentiwordnet = new SentiScoreTest(pathToSWN);
//		
